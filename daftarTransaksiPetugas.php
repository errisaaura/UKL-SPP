...
<head>
    ...
    <title>SB Petugas 2 - Tables</title>
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link" href="daftarTransaksiPetugas.php">
                    <i class="fas fa-money-check-alt"></i>
                    <span> Transaksi</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="daftarLaporanPetugas.php">
                    <i class="fas fa-money-check-alt"></i>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            ...
                            <a href="tambah-transaksi-petugas.php" class="btn btn-primary btn-icon-split">
...
if(isset($_GET['lunas'])){
    ...
    if($update){
        header("location: daftarTransaksiPetugas.php");
    }
}
?>